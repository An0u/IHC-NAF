          ...
          <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <a href="index.html" class="site_title"><i class="fa fa-clock-o"></i> <span> NAF</span></a>
                    </div>
                    ...
                    <div class="profile_pic">
                        <img src="images/visitante.jpg" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <div class="menu_section">
                        ...
                        <li><a href="{{ route('visitante') }}" ><i class="fa fa-home"></i> Inicio </a> </li>
                        <li><a href="{{ route('agendamentos') }}" ><i class="fa fa-edit"></i> Agendamentos </span></a>
                        <li><a href="{{ route('calendario') }}"><i class="fa fa-calendar"></i> Calendário <span class="label label-success pull-right"> Versão Beta </span></a></li>
                        </ul>
                    </div>
                ...
                <div class="nav_menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <img src="images/visitante.jpg" alt="">Visitante
